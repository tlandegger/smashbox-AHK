...
3. Run the smashbox-gui.ahk script. You should be able to do this by double clicking on the file after installing autohotkey. Make sure the Hotkeys.ini file is in the same dirrectory.
